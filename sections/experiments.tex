...
\midrule
XGBoost               & .820 {\tiny[.76,.86]} & .612 {\tiny[.49,.72]} & 1.000 & 0\% \\
Cost-Sens.\ XGB       & .795 {\tiny[.74,.85]} & .602 {\tiny[.48,.70]} & 1.000 & 0\% \\
Mozannar-Sontag       & .830 {\tiny[.78,.88]} & .646 {\tiny[.53,.75]} & 1.000 & 0\% \\
Conf.\ threshold      & .900 {\tiny[.86,.94]} & .792 {\tiny[.69,.87]} & .938 & 23\% \\
\textbf{Safe-L2D-Fraud} & \textbf{.895} {\tiny[.85,.94]} & .788 {\tiny[.69,.87]} & \textbf{.923} & 36\% \\
\bottomrule
\end{tabular}
\end{small}
\end{center}
...
Second, the \textit{confidence threshold achieves the highest point accuracy} (90.0\%) with only 23\% deferral vs.\ Safe-L2D-Fraud's 89.5\% at 36\%. The CVaR difference ($0.923$ vs.\ $0.938$) is directionally consistent with better tail-risk control but rests on ${\approx}20$ tail samples and is not statistically significant. The principal advantage of Safe-L2D-Fraud is the principled risk-control mechanism rather than raw accuracy.
...
\Cref{fig:ablation} shows each component's contribution. Removing Bayesian entropy drops the deferral rate from 36\% to 7\% and accuracy to 82.5\%; removing CVaR monitoring drops accuracy to 82.5\% at 26\% deferral. Because the variants operate at different deferral rates, accuracy differences may partly reflect the amount of deferral rather than component quality; a comparison at fixed coverage would be more informative.
