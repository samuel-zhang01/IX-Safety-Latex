...
We model insurance fraud detection as a learning-to-defer problem. Each claim $\xx \in \mathcal{X} \subseteq \RR^d$ has a binary label $y \in \{0, 1\}$ (legitimate or fraudulent). The system must choose one of three actions: $a \in \{\text{clear}, \text{flag}, \text{deffer}\}$. When the system defers, a human fraud investigator $M$ examines the claim with accuracy parameterised by $\alpha \in (0, 1]$.
